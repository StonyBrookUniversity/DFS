...
######################################################################################################################
        if Flow[1] in RouterDict:
            if Flow[1] in SRouterDict: ##Case 1: If source-router exists in S (and R): Add new source
                ...
                RouterDict[Flow[1]][newSource].append(["ipsrc=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter)])
                RouterDict[Flow[1]][newSource].append(["ipdst=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter+5)])
                ...
                RouterDict[Flow[1]]['s1'].append(["ipsrc=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter)])
                RouterDict[Flow[1]]['s1'].append(["ipdst=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter+5)])
            ...
            SRouterDict[Flow[1]]['s1'].append(["ipsrc=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter)])
            SRouterDict[Flow[1]]['s1'].append(["ipdst=%d.%d.%d.0/24"%(counter/40000+1,counter/200+1,counter+5)])
