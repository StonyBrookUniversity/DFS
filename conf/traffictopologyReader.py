...
import sys
import random
fi = open("traffic_matrix_006_light", "r")
fj = open("navid_16_0_0_72_d1", "r")
fo = open("006_16_0_0_72_d1_light.dot", "wb")
sys.stdout=fo
print "graph test {"
...
for line in fj:
    if line!= "":
        ...
        if Link[0][0]=='S' and Link[1][0]=='S':
            print 'H'+Link[0].strip('S')+ " -- "+'H'+Link[1].strip('S')+"[weight ="+str(random.randint(1,10))+", capacity ="+str(random.randint(1000000,100000000))+", delay ="+str(random.randint(0,1))+"]"
